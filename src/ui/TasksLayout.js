...
class TaskLayout {
  ...
  taskList() {
    ...
    taskBox.classList.add('Box', 'mb-4', 'tasks', 'mt-6');
    ...
    for (const item of this.tasks) {
      ...
      jobTaskItem.innerHTML = `
        <div class="flex-auto"><strong>Task title 1</strong>
          <div class="text-small text-gray-light">
            <div><strong>Due:</strong> 2021-06-18</div>
            <strong>Desc:</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus voluptatem ipsa ut sit
            nesciunt quisquam culpa, consequatur error.
            <div class="text-bold color-text-success"><strong>Priority:</strong> normal</div>
            <div>
        ...
        </div><button class="btn btn-sm" data-status-button="">In progress...</button>
      `;
